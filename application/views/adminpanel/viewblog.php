    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        <li class="active"><a href="<?php echo base_url().'admin/dashboard'?>"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
                        <li><a href="<?php echo base_url().'admin/blog/addBlog'?>"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Add Blog</span></a></li>
                        <li><a href="<?php echo base_url().'admin/blog'?>"><i class="fa fa-bar-chart" aria-hidden="true"></i><span class="hidden-xs hidden-sm">view Blog</span></a></li>
                   </ul>
                </div>
            </div>
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="header-rightside">
                                <ul class="list-inline header-top pull-right">
                                    <li class="hidden-xs"><a href="<?php echo base_url().'admin/blog/addBlog'?>" class="add-project" data-toggle="modal" data-target="#add_project">Add Blog</a></li>
																		<li class="hidden-xs"><a href="<?php echo base_url().'admin/login/logout'?>"
																		 class="add-project" data-toggle="modal" data-target="#add_project">Logout</a></li>
                                    <li><a href="<?php echo base_url().'admin/login/logout'?>"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
					...
					<div class="row p-5 ml-20">
                        <div class="col-md-12 p-3">
                            <table class="table">
                                <thead>
                                    <tr>
								    	<th class="border-0 text-uppercase small font-weight-bold">Sr No</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Blog Title</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Blog Description</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Image</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Edit</th>
										<th class="border-0 text-uppercase small font-weight-bold">Delete</th>
                                    </tr>
                                </thead>
                                <tbody>
								...
								if($result){
									...
									foreach($result as $key=>$value){
										...
										<td><img src='".base_url().$value['blog_img']."'
										class='img-fluid' width='100' </td>
										<td>321</td>
										<td>
										<a class=\"btn btn-info\" href='". 
										 base_url().'admin/blog/editblog/'.$value['blogid']."'> edit</a>
										</td> 
										<td>
										<a class=\"btn  delete btn-danger\" 
										href='#.' data-id='".$value['blogid']."' > delete </a>
										</td>
									...
									echo "<tr> <td colspan=6> No record fount </td> </tr>";
								}
...
<script type="text/javascript">
   $(".delete").click(function(){
	   ...
	   if(bool){
         $.ajax({
			 url: "<?php echo base_url().'admin/blog/delete/' ?>"+delete_id,
			 type:'post',
