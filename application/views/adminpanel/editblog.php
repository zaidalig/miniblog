		...
		<div class="row display-table-row">
			...
			<div class="col-md-10 col-sm-11 display-table-cell v-align">
						...
						<div class="col-md-5">
							<div class="header-rightside">
								<ul class="list-inline header-top pull-right">
									...
									<li class="hidden-xs"><a href="<?php echo base_url() . 'admin/login/logout' ?>" class="add-project" data-toggle="modal" data-target="#add_project">Logout</a></li>
				...
				<div class="user-dashboard">
					<h1>Edit Blog</h1>
					<div class="row">
						<div class="col-md-9 col-sm-9 col-xs-12 gutter">


						</div>
						<div class="col-md-12 col-sm-12 col-xs-12 gutter">
							<form enctype="multipart/form-data" action="<?php echo base_url() . 'admin/blog/editblogpost' ?>" method="post">

								<div style="padding-bottom: 20">
									<select class="custom-select pb-10 form-control" name="publish_unpublish" id="">
								...
								<div class="form-group">
									<input type="text" name="blog_title" value="<?= $result[0]['blog_title'] ?>" placeholder="Title" class="form-control">
								</div>

								<div class="form-group">
									<textarea type="text" name="desc" placeholder="Blog Discription" class="form-control">
								...
								<div class="form-group col-md-4 ">
									...
									<input type="file" name="file" placeholder="image for blog" class="form-control">
